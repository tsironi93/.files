...
/* ************************************************************************** */
	  ...
	  filename, string.rep(" ", filename_padding),
	  user, email, string.rep(" ", email_padding),
	  os.date("%Y/%m/%d %H:%M:%S"), user, string.rep(" ", created_user_padding),
	  os.date("%Y/%m/%d %H:%M:%S"), user, string.rep(" ", updated_user_padding)
	)
